...
def find_button_on_screen(button_image_path, device_id=None, threshold=0.8):
...
def check_button_exists(button_name, device_id=None, threshold=0.8):
...
def find_and_click_button(button_name, device_id=None, wait_time=1, max_retries=3, threshold = 0.8):
    ...
    return False
def find_button_position(button_image_path, device_id=None, threshold=0.8):
